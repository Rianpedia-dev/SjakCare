...
async function seed() {
  console.log("🚀 Memulai proses seeding basis pengetahuan...");

  try {
    // 1. Jalankan Raw SQL untuk membuat tabel knowledge_base jika drizzle-kit push mengalami error
    console.log("📂 Memastikan tabel 'knowledge_base' telah terbuat di database...");
    ...
    // 2. Bersihkan data lama agar tidak duplikat
    console.log("🧹 Membersihkan data pengetahuan lama...");
    await db.delete(knowledgeBase);

    // 3. Masukkan data pengetahuan baru
    console.log("📥 Memasukkan data pengetahuan baru...");
    ...
    console.log("🎉 Proses seeding RAG berhasil diselesaikan dengan sukses!");
    process.exit(0);
  } catch (error) {
